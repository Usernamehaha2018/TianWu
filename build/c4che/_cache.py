...
EXAMPLE_DIRECTORIES = ['udp-client-server', 'tutorial', 'realtime', 'load-balance', 'udp', 'naming', 'energy', 'traffic-control', 'socket', 'wireless', 'routing', 'error-model', 'matrix-topology', 'tcp', 'stats', 'ipv6']
