...
CC = ['gcc-5']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-w', '-std=c++11', '-march=native', '-fstrict-overflow', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-nq92VM/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-nq92VM/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
CXX = ['g++-5']
CXXFLAGS = ['-w', '-std=c++11', '-march=native', '-fstrict-overflow']
CXXFLAGS_MACBUNDLE = ['-fPIC']
CXXFLAGS_PTHREAD = '-pthread'
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-nq92VM/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-nq92VM/python2.7-2.7.17=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['udp-client-server', 'traffic-control', 'load-balance', 'stats', 'routing', 'matrix-topology', 'energy', 'realtime', 'udp', 'error-model', 'tutorial', 'ipv6', 'tcp', 'wireless', 'naming', 'socket']
...
NS3_ENABLED_MODULES = ['ns3-antenna', 'ns3-aodv', 'ns3-applications', 'ns3-bridge', 'ns3-buildings', 'ns3-clove', 'ns3-config-store', 'ns3-conga-routing', 'ns3-congestion-probing', 'ns3-core', 'ns3-csma', 'ns3-csma-layout', 'ns3-drb-routing', 'ns3-drill-routing', 'ns3-dsdv', 'ns3-dsr', 'ns3-energy', 'ns3-fd-net-device', 'ns3-flow-monitor', 'ns3-internet', 'ns3-internet-apps', 'ns3-letflow-routing', 'ns3-link-monitor', 'ns3-lr-wpan', 'ns3-lte', 'ns3-mesh', 'ns3-mobility', 'ns3-mpi', 'ns3-netanim', 'ns3-network', 'ns3-nix-vector-routing', 'ns3-olsr', 'ns3-point-to-point', 'ns3-point-to-point-layout', 'ns3-propagation', 'ns3-sixlowpan', 'ns3-spectrum', 'ns3-stats', 'ns3-tap-bridge', 'ns3-test', 'ns3-tianwu-routing', 'ns3-tlb', 'ns3-tlb-probing', 'ns3-topology-read', 'ns3-traffic-control', 'ns3-uan', 'ns3-virtual-net-device', 'ns3-wave', 'ns3-wifi', 'ns3-wimax', 'ns3-xpath-routing']
NS3_EXECUTABLE_PATH = ['/home/mywang/ns3-load-balance/build/src/fd-net-device', '/home/mywang/ns3-load-balance/build/src/tap-bridge']
NS3_MODULES = ['ns3-antenna', 'ns3-aodv', 'ns3-applications', 'ns3-bridge', 'ns3-buildings', 'ns3-clove', 'ns3-config-store', 'ns3-conga-routing', 'ns3-congestion-probing', 'ns3-core', 'ns3-csma', 'ns3-csma-layout', 'ns3-drb-routing', 'ns3-drill-routing', 'ns3-dsdv', 'ns3-dsr', 'ns3-energy', 'ns3-fd-net-device', 'ns3-flow-monitor', 'ns3-internet', 'ns3-internet-apps', 'ns3-letflow-routing', 'ns3-link-monitor', 'ns3-lr-wpan', 'ns3-lte', 'ns3-mesh', 'ns3-mobility', 'ns3-mpi', 'ns3-netanim', 'ns3-network', 'ns3-nix-vector-routing', 'ns3-olsr', 'ns3-point-to-point', 'ns3-point-to-point-layout', 'ns3-propagation', 'ns3-sixlowpan', 'ns3-spectrum', 'ns3-stats', 'ns3-tap-bridge', 'ns3-test', 'ns3-tianwu-routing', 'ns3-tlb', 'ns3-tlb-probing', 'ns3-topology-read', 'ns3-traffic-control', 'ns3-uan', 'ns3-virtual-net-device', 'ns3-wave', 'ns3-wifi', 'ns3-wimax', 'ns3-xpath-routing']
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/mywang/ns3-load-balance/build']
...
cfg_files = ['/home/mywang/ns3-load-balance/build/ns3/config-store-config.h', '/home/mywang/ns3-load-balance/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
