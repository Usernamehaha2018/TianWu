...
EXAMPLE_DIRECTORIES = ['naming', 'error-model', 'tcp', 'traffic-control', 'ipv6', 'routing', 'energy', 'realtime', 'matrix-topology', 'wireless', 'socket', 'udp', 'load-balance', 'tutorial', 'stats', 'udp-client-server']
...
NS3_EXECUTABLE_PATH = ['/home/mywang/TianWu/build/src/fd-net-device', '/home/mywang/TianWu/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/home/mywang/TianWu/build']
...
cfg_files = ['/home/mywang/TianWu/build/ns3/config-store-config.h', '/home/mywang/TianWu/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
